...
$stmt = $conn->prepare("UPDATE newthread SET username=?, comment=? WHERE id=?");
...
<div class="row">
    ...
    <form action="editNewThread.php" method="post"> 
 <form method="post" action="<?php echo $_SERVER['PHP_SELF'];?>">

    <input type="hidden" name="id" id="id" value="<?php echo $id;?>">
        
    <label>Username of poster:</label>
               <input type="text" id="username" name="username" value="<?php echo $row["username"];?>">
               <br><br>
                       
         <br><br>
            
            <label>Thread message:</label><br><br>
