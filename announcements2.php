...
$mysqli_query="Select userreg.usertype,commentsforward.username from userreg, commentsforward"
...
if(!$username=="admin" || !$upgrade=="1"){
    ...
    echo "Sorry you don't have permission to post a thread";
     ...
     $row["id"]; ?><br>
       ...
       <a href="editNewThread.php?id=<?php echo $row["id"]; ?>">Edit</a>
<a href="deleteThread.php?id=<?php echo $row["id"]; ?>">Delete</a>
<?php  $count++; 
}} ?>  
